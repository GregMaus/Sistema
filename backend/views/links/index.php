<section id="main" class="column">
  ...
  <?php echo $this->message->display();   ?>
		...
		<article class="module width_full">
                     <form action="Linksmenu/novo_link" method="post">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display tablesorter" >
                                    ...
                                    <?php foreach ($links as $link) {  ?>
                                            ...
                                            <tr >
                                                    ...
                                                    <td><?php echo $link->id_adm_links_menu ?></td>
                                                    <td><?php echo $link->label ?></td>                                                    
                                                    <td><?php echo $link->anchor ?></td>
                                                    <td class="center">
                                                        <a href="Linksmenu/link_edit/<?php echo $link->id_adm_links_menu ?>">
                                                            <input type="image" src="assets/images/icn_edit.png" title="Edit"/>
                                                        </a>
                                                    </td>
                                                    <td class="center">
                                                        <a href="Linksmenu/link_delete/<?php echo $link->id_adm_links_menu ?>">
